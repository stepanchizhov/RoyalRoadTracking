...
def get_trending_urls():
    ...
    genres = [
        ...
        'sci_fi', 'tragedy', 'anti-hero_lead', 'artificial_intelligence', 
        'attractive_lead', 'cyberpunk', 'dungeon', 'dystopia', 'female_lead', 
        'first_contact', 'gamelit', 'gender_bender', 'genetically_engineered%20', 
        'grimdark', 'hard_sci-fi', 'harem', 'high_fantasy', 'litrpg', 
        'low_fantasy', 'magic', 'male_lead', 'martial_arts', 'multiple_lead', 
        'mythos', 'non-human_lead', 'summoned_hero', 'portal_fantasy', 
        'post_apocalyptic', 'progression', 'reader_interactive', 'reincarnation', 
        'ruling_class', 'school_life', 'secret_identity', 'slice_of_life', 
        'soft_sci-fi', 'space_opera', 'sports', 'steampunk', 'strategy', 
    ...
    try:
        ...
        if not genres or 'all' in genres:
            ...
            genre_mapping = {
                ...
                'Genetically Engineered': 'genetically_engineered%20',
